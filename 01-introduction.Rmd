...
If you are concurrently taking PSYC 3290 you can use R as you do in that course - move to the next section.

If you are not taking PSYC 3290 we have instructions for installing R and RStudio (both are needed) on your computer below. If you do not have a Mac or PC but instead are working with a tablet - contact the instructor during office hours.

### Mac

On a Mac you need to download and install R and RStudio. The RStudio software is a "frontend" for using R. Although you need to download and install both - you will only every load RStudio.
...
* Go to this [link](https://rstudio.com/products/rstudio/download/) to download the latest version of RStudio. On the page that appears scroll down until you see the following:
...
* In the Applications folder there is now an RStudio icon. Click this icon to run RStudio each time you use it. You can also drag the RStudio icon in the Applications folder to the Dock for easy access if your prefer.
...
## Begin each session with an RStudio Project
