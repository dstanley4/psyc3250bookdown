...
On a Mac you need to download and install R and RStudio. The RStudio software is a "frontend" for using R. Although you need to download and install both - you will only ever load RStudio.
...
2. Download the data_okcupid.csv file, linked: [here](https://github.com/dstanley4/psyc3250bookdown/raw/main/data_okcupid.csv) (Right click link to download file)
