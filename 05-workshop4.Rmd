...
3) Sometimes, people convert items to z-scores before combining them. When they do that, we use Standardized alpha (instead of Cronbach's alpha) to describe the column of scale scores.
