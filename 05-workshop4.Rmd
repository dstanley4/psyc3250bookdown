...
1) People combine items (by adding them together) to create a scale scores.

2) One way we can describe the quality of scale scores is using Cronbach's alpha.
