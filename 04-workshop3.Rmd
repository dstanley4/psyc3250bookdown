...
As well, check for yourself that the affect_sum column is the sum of the three items for each person.
...
With the second approach to getting the variance of the number we use the cov() (i.e., covariance command). You can see in commands below produce a covariance matrix.
...
## Variance of the SUM of these columns
...
+ 2*COV(\text{aff_com2},\text{aff_com3}) 
+ 2*COV(\text{aff_com2},\text{aff_com4}) 
+ 2*COV(\text{aff_com3}, \text{aff_com4})
$$
