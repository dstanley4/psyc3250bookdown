...
We can convert an entire column of numbers to *z*-scores with a simple calculation.

However, before we begin, we need to know the mean and standard deviation (population formula) for the original column.
