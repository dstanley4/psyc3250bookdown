...
After running the above command, you can see everyone's height as a T-score with this code. We omit the sex column from the output (using the select() command) so there are not too many columns on your screen.
